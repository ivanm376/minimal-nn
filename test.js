...
const test = () => {
  ...
  const outputs = [
    { '0': 0.20000000298023224, '1': 0.6000000238418579 },
    [0.8560302604689196],
  ...
  const errors = [{ '0': 0, '1': 0 }, { '0': 0 }, { '0': -0.07301503180017563, '1': 0.07337200044676617 }];
  const deltas = [{ '0': 0, '1': 0 }, { '0': 0 }, { '0': -0.004941937505903706, '1': 0.004988455920769976 }];
  const changes = [
    null,
    [{ '0': -0.000002187704194511752, '1': -0.00009101866744458676 }],
    [{ '0': -0.00322056850585349 }, { '0': 0.003113514183797795 }],
  ];
};
